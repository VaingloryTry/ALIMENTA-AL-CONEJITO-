...
var conejoDetector = document.getElementById("conejo-detector");

// Agregar un controlador de eventos para detectar la colisión
conejoDetector.addEventListener("mouseover", function() {
  if (detectarColision(conejo, fruta)) {
    conejo.style.animation = "feliz 1s infinite";
  }
});
